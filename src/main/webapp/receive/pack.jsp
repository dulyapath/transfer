    ...
    <div class="col-lg-12">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-4">
                                        ...
                                        <input type="text" class="form-control" id="fg_docno">
                                        <input type="hidden" class="form-control" id="wid_docno">
                                    </div>
                                    <div class="col-4">
                                        <label class="col-form-label">วันที่</label>
                                        <input type="date" class="form-control" id="fg_docdate">
                                    </div>
                                    <div class="col-4">
                                        <label class="col-form-label">หมายเหตุ</label>
                                        <input type="text" class="form-control" id="fg_remark">
                                    </div>
        ...
        <div class="modal fade" id="modalconfirm" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLongTitle">ยืนยันการทำงาน</h5>

                    </div>
                    <div class="modal-body">

                        <p class="text-center" style="font-size:18px">รับสินค้าไม่ครบ ยืนยันการทำงาน</p>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-dismiss="modal">ยกเลิก</button>
                        <button type="button" id="btn-createrim" class="btn btn-success">สร้างเอกสารรับคืนสินค้า</button>
                        <button type="button" id="btn-creatert" class="btn btn-primary">สร้างเอกสารรอรับสินค้า</button>
                    </div>
                </div>
            </div>
        </div>
