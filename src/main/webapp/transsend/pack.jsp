                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-3">
                                        ...
                                        <input type="text" class="form-control" id="wid_docno">
                                    </div>
                                    <div class="col-3">
                                        <label class="col-form-label">วันที่</label>
                                        <input type="date" class="form-control" id="wid_docdate">
                                    </div>
                                    <div class="col-3">
                                        <label class="col-form-label">หมายเหตุ</label>
                                        <input type="text" class="form-control" id="wid_remark">
                                    </div>
                                    <div class="col-3">
                                        <label class="col-form-label">สูตรราคา</label>
