...
<%    String docno = "";
    ...
    request.setAttribute("js", Arrays.asList("../js/sweetalert.min.js", "../js/transrequest/form2.js"));
    ...
    <div class="col-lg-12">
        <div class="card ">
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-12">
                        <button class="btn btn-sm btn-success btn-addline" onclick="_addLine()">เพิ่มแถว</button>
                    </div>
                </div>
