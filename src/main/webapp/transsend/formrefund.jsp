    ...
    <div class="col-lg-12">
        <div class="card ">
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-6">
                        <a href="refund.jsp" class="btn btn-warning btn-back">ยกเลิก</a>
                    </div>
