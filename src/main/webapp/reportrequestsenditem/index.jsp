...
<%    String pageName = "รายงานการโอนตามสินค้า";
    request.setAttribute("title", pageName);
    request.setAttribute("sublink", "../");
    request.setAttribute("active", "reportrequestsenditem");
    // request.setAttribute("css", Arrays.asList("../css/sweetalert.css", "../css/bootstrap-datetimepicker.min.css"));
    request.setAttribute("js", Arrays.asList("../js/sweetalert.min.js", "../js/report/reportrequestsenditem.js"));
            ...
            <table class="table table-striped table-bordered" id="tableId">
                <thead>
                    <tr >
                        ...
                        <td nowrap rowspan="2" style="vertical-align : middle;text-align:center;background-color: #dbdbdb">เลขที่ใบรับ</td>
                        <td nowrap rowspan="2" style="vertical-align : middle;text-align:center;background-color: #dbdbdb">เลขที่ใบคืน</td>
                        <td nowrap rowspan="2" style="vertical-align : middle;text-align:center;background-color: #dbdbdb">ผู้จัดทำ</td>
                        <td nowrap rowspan="2" style="vertical-align : middle;text-align:center;background-color: #dbdbdb">รายการสินค้า</td>
                        ...
                        <td colspan="6" style="vertical-align : middle;text-align:center;background-color: #ffff66">รายการ</td>
