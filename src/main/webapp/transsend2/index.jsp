...
<%    String pageName = "เบิกออก(ไม่มีใบขอเบิก)";
    ...
    request.setAttribute("js", Arrays.asList("../js/sweetalert.min.js", "../js/transsend2/transsend2.js"));
...
<div class="row" style="margin-bottom: 0.5rem">
    <div class="col-md-12">
        ...
        <button class="btn btn-success btn-add">
            <i class="fas fa-plus"></i> สร้างใบเบิกออก
        </button>
