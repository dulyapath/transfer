                        ...
                        <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordion">
                            <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-3">
                                        <label class="">สูตรราคา</label>
                                        <select class="form-control" id="price_formula">
                                            <option value="0">ราคา0</option>
                                            <option value="1">ราคา1</option>
                                            <option value="2">ราคา2</option>
                                            <option value="3">ราคา3</option>
                                            <option value="4">ราคา4</option>
                                            <option value="5">ราคา5</option>
                                            <option value="6">ราคา6</option>
                                            <option value="7">ราคา7</option>
                                            <option value="8">ราคา8</option>
                                            <option value="9">ราคา9</option>
                                        </select>
                                    </div>
                                </div>
                                <hr style="margin-bottom: 10px;margin-top: 15px;">
                                <label style="margin-bottom: 0px">เบิกออกจาก</label>
                                <div class="row">
                                    <div class="col-4">
