...
<%    String docno = "";
    ...
    String pageName = "แบบฟอร์มขอเบิก";
    ...
    request.setAttribute("js", Arrays.asList("../js/sweetalert.min.js", "../js/transrequest/form.js"));
...
<input type="hidden" value="<%=session.getAttribute("defualt_branch_code")%>" id="session_branch_code">
<input type="hidden" value="<%=session.getAttribute("defualt_wh_code")%>" id="session_wh_code">
<input type="hidden" value="<%=session.getAttribute("defualt_shelf_code")%>" id="session_shelf_code">
<input type="hidden" value="<%=session.getAttribute("defualt_to_branch_code")%>" id="session_to_branch_code">
<input type="hidden" value="<%=session.getAttribute("defualt_to_wh_code")%>" id="session_to_wh_code">
<input type="hidden" value="<%=session.getAttribute("defualt_to_shelf_code")%>" id="session_to_shelf_code">
                    ...
                    <div class="card">
                        ...
                        <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordion">
                            <div class="card-body">
                                ...
                                <label style="margin-bottom: 0px">ขอเบิกจาก</label>
                                <div class="row">
                                    <div class="col-4">
                                ...
                                <hr style="margin-bottom: 10px;margin-top: 15px;">
                                <label style="margin-bottom: 0px;">รับเข้าที่</label>
                                <div class="row">
                                    <div class="col-4">
                                        <label class="col-form-label"> สาขา</label>
                                        <select class="form-control" value="" id="to_bh"></select>
                                    </div>
                                    <div class="col-4">
                                        <label class="col-form-label">คลัง</label>
                                        <select class="form-control" value="" id="to_wh"></select>
                                    </div>
                                    <div class="col-4">
                                        <label class="col-form-label">ที่เก็บ</label>
                                        <select class="form-control" value="" id="to_sh"></select>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-center">หน่วยนับ</th>
                                        <%if (session.getAttribute("show_balance").equals("1")) {%>
