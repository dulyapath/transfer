        ...
        success: function (res) {
            ...
            if (res.length > 0) {
                ...
                for (var _loop = 0; _loop < _totalPage; _loop++) {
                    ...
                    __rsHTML += "</div>";
                    __rsHTML += "<div class='col-sm-6 '>";
                    __rsHTML += "<p class='text-right'>วันที่: " + res[0].wid_date + " เวลา: " + res[0].doc_time + " | หน้า" + (_loop + 1) + "/" + _totalPage + "</p></p>";
                    __rsHTML += "</div>";
                    __rsHTML += "</div>";
                    __rsHTML += "<div class='row' style='font-size: 18px;'>";
                ...
                <div style="padding-bottom:10px">
                    ...
                    for (var i = _loopRowCount; i < _perLoop; i++) {
                        ...
                        __rsHTML += '<td class="text-right">' + formatNumber(parseFloat(res[0].detail[i].price) * parseFloat(res[0].detail[i].qty)) + '</td>'
                        __rsHTML += '</tr>'
                        _loopRowCount++;
                    }
