...
$(document).ready(function () {
    ...
    $('.btn-add').on('click', function () {
        ...
        window.location.href = "form.jsp?s=6";
    });
    ...
    function printData(data) {
        window.open('print.jsp' + "?docno=" + data, "_blank");
    }
...
function _getListData(data) {
    ...
    $.ajax({
        url: serverURL + 'getDocSendDirect?fd=' + from_date + '&td=' + to_date + '&search=' + data,
        method: 'GET',
        cache: false,
        success: function (res) {
...
function _showListDetail(data) {
    ...
    for (var i = 0; i < data.length; i++) {
        ...
        if (data[i].status == "0") {
            ...
            statusText = "ส่งใบขอเบิกแล้ว"
            color = "orange";
        } else if (data[i].status == "2") {
            html += `<div class="card border-bottom-info">`
            statusText = "สร้างใบเบิกแล้ว"
            color = "green";
        ...
        if (data[i].status == "6") {
            html += `<button class="btn btn-success btn-icon-split send_approve" data-docno="${data[i].doc_no}">
                            ...
                            <span class="text">ส่งใบขอเบิก</span>
                        </button>`
            ...
            html += ` <button  class="btn btn-warning btn-icon-split print_doc" data-docno="${data[i].doc_no}">
                            <span class="icon text-white-50">
            ...
            html += `<button class="btn btn-info btn-icon-split show_detail" data-docno="${data[i].doc_no}">
                            <span class="icon text-white-50">
                                <i class="fas fa-info"></i>
                            </span>
                            <span class="text">รายละเอียด</span>
            ...
            html += ` <button  class="btn btn-info btn-icon-split show_detail" data-status="0" data-docno="${data[i].doc_no}">
                            <span class="icon text-white-50">
                                <i class="fas fa-info"></i>
                            </span>
                            <span class="text">รายละเอียด</span>
