...
function _showListDetail(data) {
    ...
    for (var i = 0; i < data.length; i++) {
        ...
        html += `    <div class="card-body">
                <div class="row">
                    <div class="col-12">
                        <div class="text-header text-left">${data[i].rim_doc} <span class="text-header text-right" style="color:${color}">รับคืนแล้ว</span></div>
                    </div>
                ...
                <div class="row" style="margin-top: 0.5rem;">
                    ...
                    <div class="col-4">
                        <div class="text-body text-left">ผู้อนุมัติ :  ${data[i].rim_user}</div>
                    </div>
                </div>
                <div class="row" style="margin-top: 0.5rem;">
                    <div class="col-4">
        ...
        html += `            <div class="col-8">
                        <div class="text-body text-left">หมายเหตุ : ${data[i].rim_remark}</div>
                    </div>
