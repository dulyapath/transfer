...
<%    String docno = "";
    ...
    String pageName = "รายละเอียดใบรับ";
    ...
    request.setAttribute("js", Arrays.asList("../js/sweetalert.min.js", "../js/history/formdetail.js"));
    ...
    <div class="col-lg-12">
        <div class="card ">
            <div class="card-body">
                <div class="row">
                    <div class="col-12">
                        <p ><b>เลขที่ใบขอโอน</b> : <span id="doc_no"></span> <b style="margin-left:1.25em"> วันที่:</b> <span id="doc_date"></span> <b style="margin-left:1.25em">ผู้ขอ:</b> <span id="creator_code"></span></p>
                    </div>
                </div>
                <div class="row">
                    <div class="col-12">
                        <p ><b>ขอโอนจาก สาขา:</b> <span id="from_bh"></span> <b style="margin-left:1.25em"> คลัง:</b> <span id="from_wh"></span> <b style="margin-left:1.25em">ที่เก็บ:</b> <span id="from_sh"></span></p>
                    </div>
                </div>
                <div class="row">
                    <div class="col-12">
                ...
                <div class="row">
                    <div class="col-12">
                        <p ><b>เลขที่ใบโอน:</b> <span id="doc_wid"></span>  <b>เลขที่ใบรับ:</b> <span id="doc_fg"></span> <b>เลขที่ใบรับคืน:</b> <span id="doc_rim"></span></p>
                    </div>
                </div>
                <div class="row">
                    <div class="col-12">
                ...
                <div class="row">
                    <div class="col-6">
                        <a href="refund.jsp" class="btn btn-warning btn-back">กลับสู่เมนูกลับ</a>
                    </div>
