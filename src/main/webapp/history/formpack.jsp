...
<%    String docno = "";
    ...
    String pageName = "ประวัติรับสินค้า";
    ...
    request.setAttribute("js", Arrays.asList("../js/sweetalert.min.js", "../js/history/formpack.js"));
    ...
    <div class="col-lg-12">
        <div class="card ">
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-6">
                        <a href="index.jsp" class="btn btn-warning btn-back">กลับสู่เมนูกลับ</a>
                    </div>
