...
@WebServlet(name = "docrequesthistoryreport-detail", urlPatterns = {"/getDocRequestHistoryDetailReport"})
public class getDocRequestHistoryDetailReport extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String query2 = "select *,COALESCE((select price_0 from ic_inventory_price_formula where ic_code = ic_transfer_detail_temp.item_code and unit_code = ic_transfer_detail_temp.unit_code limit 1),'')as price,COALESCE((select name_1 from ic_unit where ic_unit.code = ic_transfer_detail_temp.unit_code),'')as un_name,\n"
                    ...
                    + "                            from ic_transfer_detail_temp where doc_no = '" + request.getParameter("docno") + "' and event_qty > 0 order by line_number";
