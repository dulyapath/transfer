...
@WebServlet(name = "docrequestsend-detail", urlPatterns = {"/getDocRequestSendDetail"})
public class getDocRequestSendDetail extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String query2 = "select *,COALESCE((select price_" + price + " from ic_inventory_price_formula where ic_code = ic_transfer_detail_temp.item_code and unit_code = ic_transfer_detail_temp.unit_code limit 1),'')as price,"
                    + " COALESCE((select name_1 from ic_unit where ic_unit.code = ic_transfer_detail_temp.unit_code),'')as un_name,\n"
