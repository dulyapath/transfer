...
@WebServlet(name = "docwid-save", urlPatterns = {"/saveDocWid"})
public class saveDocWid extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (row > 0) {
                PreparedStatement __stmt_delete = __conn.prepareStatement("update ic_transfer_doc_temp set status=2 ,price_formula = '" + __price_formula + "',branch_code = '" + __from_bh + "',wh_code='" + __from_wh + "',shelf_code='" + __from_sh + "', wid_doc = '" + __wid_doc_no + "' where doc_no = '" + __doc_no + "';");
