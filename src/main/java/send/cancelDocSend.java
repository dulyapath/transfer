...
@WebServlet(name = "cancelDocSend-request", urlPatterns = {"/cancelDocSend"})
public class cancelDocSend extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            _insert_trans_sale_temp.append("update ic_transfer_doc_temp set status=3 where doc_no = '" + __doc_no + "';");
