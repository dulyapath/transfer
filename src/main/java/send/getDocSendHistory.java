...
@WebServlet(name = "senddochistory-sale", urlPatterns = {"/getRequestDocSendHistory"})
public class getDocSendHistory extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (!request.getParameter("fd").equals("")) {
            from_date = " and wid_date between '" + request.getParameter("fd") + "' and '" + request.getParameter("td") + "' ";
        }
        ...
        try {
            ...
            while (__rsHead.next()) {
                ...
                obj.put("doc_date", __rsHead.getString("wid_datex"));
                obj.put("doc_time", __rsHead.getString("wid_time"));
