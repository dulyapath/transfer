...
@WebServlet(name = "getShowDocSendDetailreport-detail", urlPatterns = {"/getShowDocSendDetailReport"})
public class getShowDocSendDetailReport extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String branch_code = "";
            String wh_code = "";
            PreparedStatement __stmt_update = __conn.prepareStatement("update ic_transfer_doc_temp set is_print='1' where doc_no = '" + request.getParameter("docno") + "';");
