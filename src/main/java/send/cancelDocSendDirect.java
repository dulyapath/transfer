...
@WebServlet(name = "cancelDocSendDirect-request", urlPatterns = {"/cancelDocSendDirect"})
public class cancelDocSendDirect extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            _insert_trans_sale_temp.append("update ic_trans set last_status=1 where doc_no = '" + __wid_doc + "';update ic_trans_detail set last_status=1 where doc_no = '" + __wid_doc + "';delete from ic_transfer_doc_temp where doc_no = '" + __doc_no + "';delete from ic_transfer_detail_temp where doc_no = '" + __doc_no + "';");
