...
@WebServlet(name = "senddoc-sale", urlPatterns = {"/getRequestDocSend"})
public class getDocSend extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            while (__rsHead.next()) {
                ...
                obj.put("is_print", __rsHead.getString("is_print"));
