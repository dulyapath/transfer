...
@WebServlet(name = "receivedoc-sale", urlPatterns = {"/getReceiveDoc"})
public class getDocReceive extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            while (__rsHead.next()) {
                ...
                obj.put("wid_date", __rsHead.getString("wid_docdatex"));
