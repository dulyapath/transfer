...
@WebServlet(name = "docrequestrec-save", urlPatterns = {"/saveDocRequestReceive"})
public class saveDocRequestReceive extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            _insert_trans_sale_temp.append("insert into ic_transfer_doc_temp (status,doc_no,doc_date,remark,user_code,wh_code,shelf_code,branch_code,to_wh_code,to_shelf_code,to_branch_code) "
                    + "values (2,'" + __doc_no + "','" + __doc_date + "','" + __remark + "','" + __user_code + "','" + __from_wh + "','" + __from_sh + "','" + __from_bh + "','" + __to_wh + "','" + __to_sh + "','" + __to_bh + "')");
