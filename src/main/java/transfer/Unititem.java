...
@WebServlet(name = "Unit-item", urlPatterns = {"/unit_item"})
public class Unititem extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String query1 = "select code,coalesce((select name_1 from ic_unit where ic_unit.code = ic_unit_use.code),'')as name_1"
                    + " from ic_unit_use where ic_code = '" + request.getParameter("code") + "'";
