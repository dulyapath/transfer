...
@WebServlet(name = "itemscan-item", urlPatterns = {"/getItemScan"})
public class getItemScanner extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String query1 = "select code,name_1,unit_cost,(select name_1 from ic_unit where code = unit_cost )as unit_name from ic_inventory where code = '" + request.getParameter("code") + "'";
