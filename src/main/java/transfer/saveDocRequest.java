...
@WebServlet(name = "docrequest-save", urlPatterns = {"/saveDocRequest"})
public class saveDocRequest extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            for (int i = 0; i < jsonArray.length(); i++) {
                ...
                _insert_trans_sale_details_temp.append("insert into ic_transfer_detail_temp (line_number,doc_no,item_code,item_name,unit_code,qty,balance,event_qty) values "
                        + "(" + obj.get("line_number") + ",'" + __doc_no + "','" + obj.get("item_code") + "','" + obj.get("item_name") + "','" + obj.get("unit_code") + "'," + obj.get("qty") + "," + obj.get("balance") + "," + obj.get("qty") + ");");
            }
