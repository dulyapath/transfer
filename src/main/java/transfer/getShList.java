...
@WebServlet(name = "sh-list", urlPatterns = {"/getShList"})
public class getShList extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String query1 = "select code,name_1 from ic_shelf where whcode in (" + _whList + ") ";
