...
@WebServlet(name = "getpriceformula-item2", urlPatterns = {"/getPriceformula"})
public class getPriceformula extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String query1 = "select price_"+price+" as price from ic_inventory_price_formula where ic_code = '" + request.getParameter("code") + "' and unit_code = '" + request.getParameter("unit") + "' limit 1 ";
