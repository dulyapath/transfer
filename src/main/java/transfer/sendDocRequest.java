...
@WebServlet(name = "send-doc-request", urlPatterns = {"/sendDocRequest"})
public class sendDocRequest extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            _insert_trans_sale_temp.append("update ic_transfer_doc_temp set status=1 where doc_no = '" + __doc_no + "';");
