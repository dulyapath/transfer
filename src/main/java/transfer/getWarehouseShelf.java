...
@WebServlet(name = "getWarehouseShelf-list", urlPatterns = {"/getWarehouseShelf"})
public class getWarehouseShelf extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (!request.getParameter("bh").equals("")) {
            keyword = request.getParameter("bh");
        }
    ...
    /*    System.out.println("whList.length "+whList.length);
        ...
        try {
            ...
            String query1 = "select code from ic_warehouse where branch_code = '" + keyword + "' ";
            ...
            while (__rsHead.next()) {
                ...
                obj.put("wh_code", __rsHead.getString("code"));
