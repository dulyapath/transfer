...
@WebServlet(name = "BranchUser-list", urlPatterns = {"/getBranchListUser"})
public class getBranchListUser extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        String __bhcode = _sess.getAttribute("rev_branch_code").toString();
