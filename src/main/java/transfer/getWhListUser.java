...
@WebServlet(name = "whuser-list", urlPatterns = {"/getWhListUser"})
public class getWhListUser extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        String __whcode = _sess.getAttribute("rev_wh_code").toString();
        ...
        try {
            ...
            String query1 = "select code,name_1 from ic_warehouse where code in (" + _whList + ") ";
